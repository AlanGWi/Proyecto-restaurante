  ...
  <div class="container">
    <div class="card shadow-lg p-4">
          ...
          <table class="table table-bordered align-middle text-center">
            ...
            <tfoot>
              <tr>
                ...
                <td><strong>${{ pedidosPorMesa.total.toFixed(0) }}</strong></td>
              </tr>
              <tr>
                <td colspan="2" class="text-end"><strong>Propina:</strong></td>
                <td><strong>${{ propina.toFixed(0) }}</strong></td>
              </tr>
              <tr class="table-primary">
                <td colspan="2" class="text-end"><strong>Total a pagar:</strong></td>
                <td><strong>${{ totalConPropina.toFixed(0) }}</strong></td>
              </tr>
            </tfoot>
          </table>
        </div>
      ...
      <div v-else class="text-center">
        <h4 class="text-danger">No hay pedidos para esta mesa.</h4>
      </div>
    </div>
  </div>
</template>
